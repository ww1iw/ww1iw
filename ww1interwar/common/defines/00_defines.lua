...
NDiplomacy = {
	...
	TRUCE_BREAK_COST_PP = 30000,						-- Base cost in PP of breaking a truce by joining a war or accepting a call to war ( you cannot declare war yourself until the truce if up ), this is then multiplied by the time left on the truce ( so once half the truce is up it only cost 50% of this )
	...
	BASE_PEACE_FORCE_GOVERNMENT_COST = 20000, 		-- Base cost for forcing a country to change government.
	BASE_IMPROVE_RELATION_COST = 5000,                -- Political power cost to initiate relation improvement
	BASE_IMPROVE_RELATION_SAME_IDEOLOGY_GROUP_MAINTAIN_COST = 2, -- Political power cost each update when boosting relations with nation of same ideology
	BASE_IMPROVE_RELATION_DIFFERENT_IDEOLOGY_GROUP_MAINTAIN_COST = 3,    -- Political power cost each update when boosting relations with nation of different ideology
	BASE_GENERATE_WARGOAL_DAILY_PP = 5,	-- Daily pp cost for generation of wargoals
	...
	BASE_BOOST_PARTY_POPULARITY_DAILY_PP = 3, 	-- Daily pp cost for boost party popularity
	BASE_BOOST_PARTY_POPULARITY_DAILY_DRIFT = 0.1, 	-- Daily amount of popularity that will be added by the activity.
	BASE_STAGE_COUP_DAILY_PP = 5,					-- Daily pp cost for staging a coup
	BASE_STAGE_COUP_TOTAL_COST = 50000, 				-- Equipment consume factor for stage coup.
	...
	GUARANTEE_COST = 25000,							-- Scale with the number of already guaranteed countries.
	REVOKE_GUARANTEE_COST = 8000,
...
NCountry = {
	...
	POLITICAL_POWER_CAP = 999999.0,					-- Max amount of political power country should have
...
NPolitics = {
	...
	BASE_POLITICAL_POWER_INCREASE = 1000,	-- Weekly increase of PP.
